...
if (isset($_GET['collection'])) {
	...
	$a = $db->createCategory($collection);
	...
	while($i >= 0):
		if (isset($_POST["p$i"])) {
			...
			// Change accented alphabet letters to non-accented.
...
function dashliterateString($text) {
	$dashliterateTable = array('–' => '--', '—' => '--');

	return str_replace(array_keys($dashliterateTable), array_values($dashliterateTable), $text);
}
